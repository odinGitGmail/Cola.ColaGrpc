...
namespace Cola.ColaGrpc.ColaGrpcClientInterceptor;
...
public class ClientGrpcInterceptor : Interceptor
{
    ...
    {
        var interceptorLog = _config.GetColaSection<GrpcClientOption>(SystemConstant.CONSTANT_COLAGRPCCLIENT_SECTION)
            .InterceptorLog;
        if (interceptorLog)
        {
